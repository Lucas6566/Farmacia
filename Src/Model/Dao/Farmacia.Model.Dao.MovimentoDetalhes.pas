...
function TCrudMovimentoDetalhes.OpenQuery: iCrudMovimentoDetalhes;
begin
  Result := Self;
  OpenQueryPai;
end;
...
begin
  ...
  Query.SQL.Add('WHERE COD_MOVIMENTO = :PCOD_MOVIMENTO');
...
function TCrudMovimentoDetalhes.DeleteItem: iCrudMovimentoDetalhes;
begin
  Result := Self;
  ...
  Query.SQL.Add(' DELETE FROM MOVIMENTO_DETALHES');
  Query.SQL.Add('  WHERE COD_MOVIMENTO = :pCOD_MOVIMENTO');
  Query.SQL.Add('    AND SEQ_MOVIMENTO = :pSEQ_MOVIMENTO');
  Query.SQL.Add('    AND SEQ_DETALHE   = :pSEQ_DETALHE');

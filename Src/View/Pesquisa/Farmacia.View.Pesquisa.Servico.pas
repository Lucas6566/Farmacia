...
uses
  ...
  Router4D,
  Farmacia.Util.Types,
  Farmacia.View.Cadastro.Servico, Vcl.Menus, cxButtons;
...
begin
  inherited;
  if TFormCadastroServico.ServicoShow(TpDelete, FDados) then
...
begin
  inherited;
  TFormCadastroServico.ServicoShow(TpSelect, FDados);
end;

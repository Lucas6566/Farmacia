object FormConexao: TFormConexao
  ...
  object QyServico: TFDQuery
    ...
    Left = 490
    Top = 24
    object QyServicoCOD_SERVICO: TIntegerField
      FieldName = 'COD_SERVICO'
      Origin = 'COD_SERVICO'
      Required = True
    end
    object QyServicoDES_SERVICO: TStringField
      FieldName = 'DES_SERVICO'
      Origin = 'DES_SERVICO'
      Size = 80
    end
    object QyServicoTIP_SERVICO: TIntegerField
      FieldName = 'TIP_SERVICO'
      Origin = 'TIP_SERVICO'
    end
    object QyServicoVLR_SERVICO: TBCDField
      FieldName = 'VLR_SERVICO'
      Origin = 'VLR_SERVICO'
      Precision = 15
    end
    object QyServicoCOD_USUARIO_ALT: TIntegerField
      FieldName = 'COD_USUARIO_ALT'
      Origin = 'COD_USUARIO_ALT'
    end
    object QyServicoDAT_CADASTRO: TSQLTimeStampField
      FieldName = 'DAT_CADASTRO'
      Origin = 'DAT_CADASTRO'
    end
    object QyServicoDAT_ALTERACAO: TSQLTimeStampField
      FieldName = 'DAT_ALTERACAO'
      Origin = 'DAT_ALTERACAO'
    end
  end
